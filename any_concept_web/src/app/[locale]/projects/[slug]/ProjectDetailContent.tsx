...
import { getProjectBySlugSync, getAllProjectsSync } from '@/data/localizedData';
...
export default function ProjectDetailContent() {
  ...
  const projectData = useMemo(
    () => getProjectBySlugSync(locale, slug),
    [locale, slug]
  );

  const allProjects = useMemo(() => getAllProjectsSync(locale), [locale]);

  const { prevProject, nextProject } = useMemo(() => {
    if (!projectData) return { prevProject: null, nextProject: null };
